...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $query = "INSERT INTO aufgabe (name, beschreibung, hinweis, fach, kategorie, pdf_file, add_date, added_by) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
  $stmt = mysqli_prepare($conn, $query);
  mysqli_stmt_bind_param($stmt, 'ssssssss', $aufgabe_name, $beschreibung, $hinweis, $fach, $kategorie, $current_date, $pdf_file, $current_userId);
